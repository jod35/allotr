    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term', models.CharField(choices=[('Jan', 'January'), ('May', 'May'), ('Sep', 'September')], default='Jan', max_length=25)),
        ...
        migrations.AddField(
            model_name='intake',
            name='courses',
            field=models.ManyToManyField(through='intakes.IntakeCourse', to='courses.Course'),
        ),
    ]
